setwd("D:/Dropbox/Broad/Script")

## load sample data sets
load("D:/Dropbox/Broad/Script/sample_data/r.rda") # alternate allele
load("D:/Dropbox/Broad/Script/sample_data/cov.sc.rda") # total coverage
...
allele_plot <- plotAlleleProfile(r.sub = allele_matrix$alter_less_sc, n.sc.sub = allele_matrix$cov_sc, 
                                 l.sub = allele_matrix$alter_less_bulk, n.bulk.sub = allele_matrix$cov_bulk, 
